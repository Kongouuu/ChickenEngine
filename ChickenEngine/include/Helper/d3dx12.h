...
inline void D3D12DecomposeSubresource( uint32_t Subresource, uint32_t MipLevels, uint32_t ArraySize, _Out_ T& MipSlice, _Out_ U& ArraySlice, _Out_ V& PlaneSlice )
{
